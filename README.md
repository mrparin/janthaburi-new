...
## Farm Summary Risk Criteria (Audit Reference)

แหล่งโค้ดอ้างอิง: [app/farm_summary.py](app/farm_summary.py)

### เกณฑ์ให้คะแนนความเสี่ยง (risk_score)
...
### เกณฑ์แปลงคะแนนเป็นระดับความเสี่ยง
